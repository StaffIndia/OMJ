...
class Setting extends CI_Controller {
	...
	public function index()
	{
		...
		// $this->form_validation->set_rules('scriptolutionuserslogan', 'Profile Heading', 'callback_alpha_dash_space');
		// // $this->form_validation->set_rules('description', 'Description', 'required');
		// $this->form_validation->set_rules('scriptolutionperhour', 'Hourly rate', 'required|numeric');
	...
	if ($this->form_validation->run() == FALSE)
                {
						...
						$this->load->view('settings',$f_data);
                ...
                else
                {
					...
					// $data['scriptolutionperhour']=$this->input->post('scriptolutionperhour');
